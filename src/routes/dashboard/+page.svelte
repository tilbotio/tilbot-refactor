                    ...
                    {#each data.projects as p, index}
                      <tr>
                        ...
                        <td class="text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" on:click={p.status?view_bot(p.id):undefined} fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 inline-block {p.status?'cursor-pointer':'disabled'}">
