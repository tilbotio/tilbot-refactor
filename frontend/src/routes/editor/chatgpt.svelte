                {#if !is_running}
                <button class="btn btn-circle bg-[#FFC500] hover:bg-[#ECB600] border-[#FFC500] hover:border-[#ECB600] ml-4" onclick={run_chatgpt}>
                ...
                {:else}
                <button class="btn btn-circle bg-[#FFC500] hover:bg-[#ECB600] border-[#FFC500] hover:border-[#ECB600] ml-4" onclick={stop_chatgpt}>
